...
public class BookDirectoryTestSuite {
    ...
    @Nested
    @DisplayName("Tests for books with condition")
    ...
    @Nested
    @DisplayName("Tests for books in hands of")
    class testListBooksInHansOf {
        ...
        void testListBooksInHandsOfNoBooks() {
            ...
            LibraryUser userWithNoBooks = new LibraryUser("Name", "Surname", "123456789");
        ...
        void testListBooksInHandsOfOneBook() {
            ...
            LibraryUser userWithOneBook = new LibraryUser("Name", "Surname", "123456789");
        ...
        void testListBooksInHandsOfFiveBooks() {
            ...
            LibraryUser userWithFiveBooks = new LibraryUser("Name", "Surname", "123456789");
